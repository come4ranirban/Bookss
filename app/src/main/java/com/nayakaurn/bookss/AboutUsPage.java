...
public class AboutUsPage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        String aboutustext= "Created by <b>Bhavika Technosolutions</b> for 2nd PUC Karnataka Exam. This app contains <b>2nd PUC Karnataka Exam Solved papers</b> which will help to prepare for Exam in a smart and efficient way. Access Model Papers and Study Material With Solutions.<br><br>"+
                "<b>Bhavika  TechnoSolutions</b> is a professional Website and App Designing and development Company located in Bangalore India. Bhavika TechnoSolutions dedicated to provide web based solutions to wide variety of clients. We provide customer-oriented web design services and more importantly, deliver them 100 % effectively.";
